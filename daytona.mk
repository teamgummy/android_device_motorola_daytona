...
PRODUCT_COPY_FILES += \
    ...
    device/motorola/daytona/prebuilts/scripts/postrecoveryboot.sh:recovery/root/sbin/postrecoveryboot.sh \
    device/motorola/daytona/prebuilts/lib/liba2dp.so:system/lib/liba2dp.so \
