...
BOARD_CUSTOM_RECOVERY_KEYMAPPING:= ../../device/motorola/daytona/recovery/recovery_ui.c
...
TARGET_CUSTOM_BLUEDROID := ../../../device/motorola/daytona/bluetooth/bluetooth.c
...
TARGET_SPECIFIC_HEADER_PATH := device/motorola/daytona/camera

#EGL
BOARD_EGL_CFG := device/motorola/daytona/prebuilts/etc/egl.cfg
...
#USB Tethering
BOARD_CUSTOM_USB_CONTROLLER := ../../device/motorola/daytona/UsbController.cpp
